...
namespace BEEV
{
  ...
  void
    ...
    {
        MinisatSTP::Var a = getEquals(SatSolver, toBe.index0, toBe.index1, satVar, LEFT_ONLY);
        MinisatSTP::Var b = getEquals(SatSolver, toBe.value0, toBe.value1, satVar, RIGHT_ONLY);
